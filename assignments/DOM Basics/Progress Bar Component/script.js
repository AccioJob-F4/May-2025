 ...
 *
 * This script creates an interactive multi-step progress bar with next/previous navigation.
 * The progress bar visually indicates the current step and allows users to move through steps.
 *
 * Concepts demonstrated:
 * - DOM element selection with querySelector/querySelectorAll
 * - Event listeners and handlers
 * - CSS class manipulation
 * - State management with variables
 * - Array iteration with forEach
 * - Conditional (ternary) operators
 * - Button state management (disabled property)
 */
